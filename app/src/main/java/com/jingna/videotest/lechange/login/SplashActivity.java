...
import com.jingna.videotest.lechange.login.fragment.SplashErrFragment;
import com.jingna.videotest.lechange.login.fragment.SplashNormalFragment;
...
public class SplashActivity extends Activity {
	...
	public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
		...
		mFragemnt.onRequestPermissionsResult(requestCode,permissions,grantResults);
	}
}
